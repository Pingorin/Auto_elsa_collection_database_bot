    ...
    while 1:
        ...
        for user in data:
            ...
            try:
                ...
                print(e)
            await sleep(0.5) # This sleep is fine for rate-limiting notifications
        
        # FIX: Increased sleep time from 1 second to 300 seconds (5 minutes)
        # Checking the database every second is too resource-intensive.
        await sleep(300)
